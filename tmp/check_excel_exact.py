...
try:
    ...
    print(f"Excel Venda: '{row['imovel_caixa_valor_venda']}' (type: {type(row['imovel_caixa_valor_venda'])})")
    print(f"Excel Avaliacao: '{row['imovel_caixa_valor_avaliacao']}' (type: {type(row['imovel_caixa_valor_avaliacao'])})")
